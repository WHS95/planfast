  ...
  return (
    <div className="w-80 shrink-0 border-l bg-panel flex flex-col min-h-0">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2">
        {proposal.kind === "tree" && proposal.pages.length === 0 ? (
          <div className="px-2 py-8 text-center text-xs text-muted leading-relaxed">
            <div className="mb-1">매니가 문서를 읽고 페이지 구성을 구상하는 중…</div>
            <div className="text-[11px]">첫 페이지가 정해지면 여기부터 하나씩 채워집니다. 보통 30~60초 뒤 시작해요.</div>
          </div>
        ) : proposal.kind === "tree" ? (
